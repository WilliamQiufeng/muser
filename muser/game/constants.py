...
class Constants:
    ...
    class PlayThrough:
        ...
        class NoteIndicator:
            ...
            MISS = 17
            NOT_IN_BOUND = 18
            INDICATOR_NAME = {4: "PERFECT", 10: "GREAT",
                              16: "BAD", 17: "MISS", 18: "Not In Bound"}
        ...
        def InitialPos(side: int) -> list:
            ...
            pos: list = (initials[0] * Constants.Cast.WIDTH,
                         initials[1] * Constants.Cast.HEIGHT)
            res: list = [
        ...
        def IndicatorMiss(side: int) -> tuple:
            return Constants.PlayThrough.IndicatorGet(
                side, Constants.PlayThrough.NoteIndicator.MISS)

        @staticmethod
        def IndicateWithTime(

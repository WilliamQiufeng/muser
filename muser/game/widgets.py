...
class KeyListener:
    def __init__(
            self, key, on_click=empty_function, on_touch=empty_function,
            not_on_touch=empty_function):
        self.key = key
...
class Button(Widget):
    def __init__(
            self, x, y, key, ot_frame, not_frame, on_click=empty_function,
            on_touch=empty_function):
        self.x = x
        self.y = y
